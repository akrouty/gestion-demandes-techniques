...
% Référence auditée : main, commit b5e60ae98f94adf65852936695b0ccc9c870a423.
...
\textbf{Conception technique.} Les décisions relatives à l'architecture backend (ADR-002), à la persistance (ADR-003), à l'API REST (ADR-004), à la sécurité (ADR-005) et au frontend (ADR-006) sont validées. Le contrat API REST, les conceptions de sécurité et du frontend, ainsi que le diagramme de composants V1 sont également validés. En revanche, l'ADR-001 relatif à l'architecture applicative et le diagramme de classes de conception backend restent à l'état de brouillon. Ces validations portent sur la conception et ne démontrent pas une implémentation.
